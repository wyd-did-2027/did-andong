...
export const content = {
  kr: {
    lang: "ko",
    metadata: {
      title: "WYD SEOUL 2027 DID 안동",
      description: "WYD SEOUL 2027 DID 안동 공식 웹사이트",
      ogLocale: "ko_KR",
    },
    header: {
      logoAlt: "wyd did 안동",
  ...
  en: {
    lang: "en",
    metadata: {
      title: "WYD SEOUL 2027 DID Andong",
      description: "WYD SEOUL 2027 DID Andong Official Website",
      ogLocale: "en_US",
    },
    header: {
